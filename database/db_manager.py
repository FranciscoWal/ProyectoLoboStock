...
""")
    ...
    insertar_material_default(cursor, "Pipeta Graduada 10ml", "Química", 15)
    insertar_material_default(cursor, "Bureta 50ml", "Química", 15)
    insertar_material_default(cursor, "Vaso Precipitado 250ml", "Química", 15)
    insertar_material_default(cursor, "Termómetro Digital", "Química", 15)
    insertar_material_default(cursor, "pH-metro", "Química", 15)
    insertar_material_default(cursor, "Balanza Analítica", "Química", 15)
    insertar_material_default(cursor, "Embudo Büchner", "Química", 15)
    insertar_material_default(cursor, "Kitasato 500ml", "Química", 15)
    insertar_material_default(cursor, "Refractómetro", "Química", 15)

    # Materiales de Farmacéutica
    insertar_material_default(cursor, "Mortero con Pistilo", "Farmacéutica", 15)
    insertar_material_default(cursor, "Cápsulas Gelatinas", "Farmacéutica", 15)
    insertar_material_default(cursor, "Pesas Calibración", "Farmacéutica", 15)
    insertar_material_default(cursor, "Disolutor Farmacia", "Farmacéutica", 15)
    insertar_material_default(cursor, "Granulador", "Farmacéutica", 15)
    insertar_material_default(cursor, "Comprimidora", "Farmacéutica", 15)
    insertar_material_default(cursor, "Recubridora", "Farmacéutica", 15)
    insertar_material_default(cursor, "Tamizador", "Farmacéutica", 15)
    insertar_material_default(cursor, "Viscosímetro", "Farmacéutica", 15)
    insertar_material_default(cursor, "Liofilizador", "Farmacéutica", 15)

    # Materiales de Mecatrónica
    insertar_material_default(cursor, "Arduino Uno", "Mecatrónica", 15)
    insertar_material_default(cursor, "Multímetro Digital", "Mecatrónica", 15)
    insertar_material_default(cursor, "Osciloscopio", "Mecatrónica", 15)
    insertar_material_default(cursor, "Soldador Estaño", "Mecatrónica", 15)
    insertar_material_default(cursor, "Kit Sensores", "Mecatrónica", 15)
    insertar_material_default(cursor, "Motor DC", "Mecatrónica", 15)
    insertar_material_default(cursor, "Servomotor", "Mecatrónica", 15)
    insertar_material_default(cursor, "PLC Básico", "Mecatrónica", 15)
    insertar_material_default(cursor, "Fuente Poder", "Mecatrónica", 15)
    insertar_material_default(cursor, "Protoboard", "Mecatrónica", 15)
    conn.commit()
    conn.close()
